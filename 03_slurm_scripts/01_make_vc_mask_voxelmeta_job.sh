...
#SBATCH --ntasks=1
#SBATCH --output=logs/vc_mask_s01_%j.out
#SBATCH --error=logs/vc_mask_s01_%j.err
...
python -u 01_make_vc_mask_voxelmeta.py | tee logs/vc_mask_s01_${SLURM_JOB_ID}.debug.log
